...
public class AppendFileStoreCKANDataFlowNodeFactory implements DataFlowNodeFactory
{
    public AppendFileStoreCKANDataFlowNodeFactory(String name, Map<String, String> properties)
    {
        _name       = name;
        ...
        throws InvalidClassException, InvalidNameException, InvalidMetaPropertyException, MissingMetaPropertyException, InvalidPropertyException, MissingPropertyException
    {
        ...
        {
            if (metaProperties.isEmpty())
                return (T) new AppendFileStoreCKANDataService(name, properties);
            else
